...
cold, generic, and obviously "made by AI." We lead with people. The AI is the
quiet, precise engine they never have to think about.
...
Confirmed direction: **Human & warm + Premium & minimal**, with **technical
precision in the details.**

| We are… | We are not… |
|---|---|
| Warm, human, approachable | Cutesy, casual, unserious |
| Confident and plain-spoken | Salesy, hypey, buzzword-heavy |
| Premium, restrained, considered | Flashy, cluttered, gimmicky |
| Precise and credible | Cold, robotic, "sci-fi AI" |
...
## 5. How people should FEEL (experience principles)
...
nothing sloppy. Trust is earned in the details before a single word is read.
→ *Design lever:* strict grid, disciplined type scale, real hierarchy.

### 3. "This is talking to me, not at me." *(warmth)*
Human copy, a friendly-but-confident tone, the warmth of the magenta showing up
at the right moments. They should feel understood, not sold to.
→ *Design lever:* People Magenta as the human accent; plain-language copy.

### 4. "I can see the point. I know what to do next." *(clarity → momentum)*
One clear action per screen. The gradient CTA is the obvious next step. No maze,
...
- Don't abbreviate to "HP" in customer-facing copy (collides with a certain
  printer company). Internally is fine.

---

## 8. What "not made by AI" means here (the guardrails)

We are an AI company that must not *look* like the AI-company cliché. Banned by default:

- ❌ Full-bleed purple→blue gradient backgrounds (our gradient is an accent, not wallpaper)
- ❌ Glowing robots, circuit-board motifs, floating neural-network nodes, "HUD" sci-fi UI
- ❌ Techno-babble ("revolutionary AI-powered synergy paradigm")
- ❌ Everything centered; walls of low-contrast grey text; emoji as section headers
- ❌ Dark-mode-only "hacker" aesthetic

The antidote is our own name: **be human, be calm, be precise.** See
`visual-language.md` for how the color and type deliver that, and
`voice-and-tone.md` for how the words do.
